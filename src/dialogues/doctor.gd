...
const outro = {
	"start":
	{
		...
		[
			...
			"Once we see improvement in your symptoms, you'll begin a comprehensive rehabilitation program with a physical therapist. This whole process will usually take 6-9 months, and your progress will be closely monitored to ensure a successful recovery.",
